        ...
        <div className="flex w-1/2 flex-col p-8">
          ...
          <div className="mt-8 space-y-3">
            <button
              ...
              disabled={isLoading}
              className="flex w-full items-center justify-center gap-3 rounded-lg bg-white min-h-[44px] py-3 md:py-2.5 font-semibold md:font-medium text-black hover:bg-gray-100 transition-colors disabled:opacity-50"
            >
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full rounded-lg bg-gradient-to-r from-cyan-500 to-blue-600 min-h-[44px] py-3 md:py-2.5 font-semibold md:font-medium text-white hover:from-cyan-600 hover:to-blue-700 transition-colors disabled:opacity-50"
            >
